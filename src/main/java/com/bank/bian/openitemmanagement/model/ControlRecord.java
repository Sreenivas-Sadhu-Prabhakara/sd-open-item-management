package com.bank.bian.openitemmanagement.model;
...
/**
 * The BIAN control record for this service domain: "Open Item Management Plan".
 *
 ...
 * to its asset type (Open Item). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Open Item Management Plan";
